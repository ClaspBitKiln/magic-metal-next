  ...
  return (
    <main>
      ...
      <section className="hero" id="top" aria-labelledby="hero-title">
        <Image className="hero-visual" src="/images/hero-branded-plane-left-v3.webp" alt="Брендированный грузовой автомобиль Мэджик Металл, промышленное производство, металлопрокат, трубы и детали трубопроводов" fill priority sizes="100vw" />
