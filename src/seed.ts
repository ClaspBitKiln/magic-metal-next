...
const products = [
  ...
  { title: 'Балка двутавровая', slug: 'balka-dvutavrovaya', group: 'sections', summary: 'Двутавровые балки для строительства и промышленности.', dimensions: 'По сортаменту', standards: 'ГОСТ 8239-89, ГОСТ 35087-2024, СТО АСЧМ 20-93', steelGrades: 'С235–С375, Ст3, 09Г2С', priority: 131 },
