...
export default function MarketDirectoryPage() {
  return <main className="market-page">
    ...
    <section className="market-content"><div className="market-legend"><span className="stock-green"><i />На складе</span><span className="stock-yellow"><i />Под заказ</span></div><MarketDirectory /></section><QuoteDock />
  </main>
}
