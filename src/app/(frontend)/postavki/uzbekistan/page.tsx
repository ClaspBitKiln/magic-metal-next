...
export default function UzbekistanSupplyPage() {
  return <main className="materials-page material-detail">
    <header className="materials-header"><Link href="/"><b>←</b> На главную</Link><LanguageSwitcher /><Link className="materials-cta" href="/?region=uzbekistan#request">Отправить заявку ↗</Link></header>
