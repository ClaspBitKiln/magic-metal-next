...
export const supplierCapabilityMap: SupplierCapabilityMapItem[] = [
  ...
  },
  {
    supplierCode: 'NTPZ',
    role: 'factory',
    productFamily: 'Электросварные и профильные трубы',
    productTypes: ['круглые электросварные трубы', 'водогазопроводные трубы', 'квадратные трубы', 'прямоугольные трубы'],
    geometry: 'Круглые трубы по опубликованному сортаменту включают диапазоны от малых диаметров до 159 мм на линии OTO 180; профильные — от 15×15 до 160×120 мм и более по конкретному стану.',
    grades: ['Ст3', '08ПС', '09Г2С'],
    standards: ['ГОСТ 3262', 'ГОСТ 10704', 'ГОСТ 10705', 'ГОСТ 8639-82', 'ГОСТ 8645-68', 'ГОСТ 30245-2003'],
    capabilityStatus: 'verified',
    evidence: 'official-catalog',
    sourceUrl: 'https://ntpz.ru/o-zavode/',
    checkedAt: '2026-09-09',
    notes: 'Официальный заводской материал содержит таблицы D×S и профильных размеров по конкретным станам. Точные пары сохраняются в Tube Master, а не в этом укрупнённом слое.'
  },
  {
    supplierCode: 'ZTZ',
    role: 'factory',
    productFamily: 'Трубы большого и сверхбольшого диаметра',
    productTypes: ['сварные линейные трубы', 'трубошпунт', 'свайные трубы', 'плакированные трубы', 'трубы с покрытиями'],
    geometry: 'Основной диапазон труб большого диаметра 530–2520 мм; опубликована длина 9,5–12,2 м для LDP. Для отдельных свайных решений и ШТС доступны специальные длины и исполнения.',
    grades: ['С355 и выше для ряда трубошпунтовых решений', 'высокопрочные строительные стали по ГОСТ 27772-2015', 'марки по API/заказу'],
    standards: ['ГОСТ 10706-76', 'ГОСТ 27772-2015', 'EN 10217', 'EN 10219', 'EN 10224', 'API 5L', 'API 5LD', 'ГОСТ Р 52664-2010'],
    capabilityStatus: 'verified',
    evidence: 'official-catalog',
    sourceUrl: 'https://ztz.ru/products/',
    checkedAt: '2026-09-09',
    notes: 'Официальный сайт также содержит товарные карточки с D×S, маркой, ГОСТ, ценой и полем наличия; такие записи относятся к OFFER/AVAILABILITY и должны импортироваться отдельно.'
  },
]
