...
export const standardAssortments: Record<string, StandardAssortment> = {
  'gost-8732-2025': {
    ...
    rows: [
      { size: '57×3,5 · 76×4 · 89×4', note: 'типовые складские позиции', signal: 'yellow' },
      { size: '108×4 · 133×4,5 · 159×6', note: 'часто представлены в открытых каталогах', signal: 'yellow' },
      ...
      { size: '500×30 · 530×40 · 550×50', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-8734-75': {
    dimensionLabel: 'Наружный диаметр × стенка, мм',
    rows: [
      { size: '8×1 · 10×1 · 12×1', note: 'типовые малые диаметры', signal: 'yellow' },
      { size: '16×1,5 · 20×2 · 25×2,5', note: 'часто представлены в каталогах', signal: 'yellow' },
      { size: '32×3 · 38×3 · 45×3,5 · 57×4', note: 'распространённый промышленный ряд', signal: 'yellow' },
      { size: '76×6 · 89×8 · 108×10', note: 'ограниченное открытое наличие', signal: 'yellow' },
      { size: '140×14 · 168×18 · 193×24', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-10704-91': {
    dimensionLabel: 'Наружный диаметр × стенка, мм',
    rows: [
      { size: '20×2 · 25×2 · 32×2 · 40×2', note: 'массовые складские позиции', signal: 'yellow' },
      { size: '57×3 · 76×3 · 89×3,5 · 108×4', note: 'широко представлены в каталогах', signal: 'yellow' },
      ...
      { size: '820×10 · 1020×12 · 1420×16', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-17375-2001': {
    dimensionLabel: 'Наружный диаметр × стенка, мм',
    rows: [
      { size: '57×3,5 · 76×4 · 89×4 · 108×4', note: 'ходовые отводы 90°', signal: 'yellow' },
      { size: '159×6 · 219×8', note: 'регулярное открытое предложение', signal: 'yellow' },
      { size: '273×10 · 325×12', note: 'наличие и угол требуют проверки', signal: 'yellow' },
      { size: '426×16 · 530×18', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-30753-2001': {
    dimensionLabel: 'Наружный диаметр × стенка, мм',
    rows: [
      { size: '57×3,5 · 76×4 · 89×4 · 108×4', note: 'ходовые отводы 2D', signal: 'yellow' },
      { size: '159×6 · 219×8', note: 'представлены у нескольких поставщиков', signal: 'yellow' },
      { size: '273×10 · 325×12 · 426×16', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-17376-2001': {
    dimensionLabel: 'Корпус × ответвление, мм',
    rows: [
      { size: '57×57 · 89×89 · 108×108', note: 'ходовые равнопроходные тройники', signal: 'yellow' },
      { size: '159×108 · 219×159 · 273×219', note: 'наличие зависит от исполнения', signal: 'yellow' },
      { size: '325×273 · 426×325', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-17378-2001': {
    dimensionLabel: 'Больший × меньший диаметр, мм',
    rows: [
      { size: '57×38 · 76×57 · 89×57 · 108×76', note: 'ходовые концентрические переходы', signal: 'yellow' },
  ...
  'gost-17379-2001': {
    dimensionLabel: 'Наружный диаметр × стенка, мм',
    rows: [
      { size: '57×3,5 · 89×4 · 108×4', note: 'ходовые заглушки', signal: 'yellow' },
      { size: '159×6 · 219×8 · 273×10', note: 'наличие требует проверки', signal: 'yellow' },
      { size: '325×12 · 426×16', note: 'не найдено в открытом складском предложении', signal: 'yellow' },
    ],
  },
  'gost-33259-2015': {
    dimensionLabel: 'Номинальный диаметр и давление',
    rows: [
      { size: 'DN 15–100 · PN 6–16', note: 'широкое складское предложение', signal: 'yellow' },
      { size: 'DN 125–300 · PN 16–40', note: 'исполнение и поверхность уточняются', signal: 'yellow' },
      { size: 'DN 350–800 · PN 63–160', note: 'преимущественно заказное изготовление', signal: 'yellow' },
    ],
  },
}

export const assortmentCheckedAt = '30 августа 2026'
